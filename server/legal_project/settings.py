"""
Django settings for legal_project.
"""
...
DATABASES = {
    'default': {
        'ENGINE': str(config('DATABASE_ENGINE', default='django.db.backends.sqlite3', cast=str)),
        'NAME': BASE_DIR / str(config('DATABASE_NAME', default='db.sqlite3', cast=str)),
    }
}
